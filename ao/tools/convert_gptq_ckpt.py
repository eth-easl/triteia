...
def main(args):
    ...
    quantized_modules = [x.removesuffix(".qweight") for x in tensors.keys() if 'qweight' in x]
    for module in quantized_modules:
        qweight, scales, zeros, bias = convert_to_bitblas(args.bitwidth, module, tensors)
