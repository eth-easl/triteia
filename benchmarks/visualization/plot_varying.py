...
filename = 'ldmm_bench_varying_split.json'
y_label = "latency" # "MFU" or "latency"
x_label = "Number of sbmm queries"

# number of models
nm = [1, 10, 20, 30, 40, 50, 60, 70, 80, 90, 99]

label_map = {"MFU": "mfu", "latency": "elapsed"}

title = f"{y_label} for 100 queries split between 100 sbmm and lora models"
out_dir = "./"
